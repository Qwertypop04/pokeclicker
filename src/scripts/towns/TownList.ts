...
TownList['Driftveil City'] = new Town(
    ...
    GameConstants.Region.unova,
    GameConstants.UnovaSubRegions.Unova,
    [TemporaryBattleList['Hugh 7'], TemporaryBattleList['Clay'], DriftveilCityShop, new ShardTraderShop(GameConstants.ShardTraderLocations['Driftveil City']), DriftveilBerryMaster],
    {
        requirements: [
