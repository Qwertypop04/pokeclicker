...
TownList['Driftveil City'] = new Town(
    ...
    GameConstants.Region.unova,
    GameConstants.UnovaSubRegions.Unova,
    [TemporaryBattleList['Hugh 7'], TemporaryBattleList['Clay'], DriftveilCityShop, new ShardTraderShop(GameConstants.ShardTraderLocations['Driftveil City'])],
    {
        requirements: [
...
const Calyrex4 = new NPC ('Calyrex', [
    ...
    image: 'assets/images/npcs/speciaNPCs/Possessed Peony.png',
